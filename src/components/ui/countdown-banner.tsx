  ...
  return (
    <section id="partners" className="relative z-10 px-4 py-20 md:px-8">
      <motion.div
        ...
        className="mx-auto max-w-6xl overflow-hidden border border-ink/10 bg-white/64 p-8 text-center shadow-editorial backdrop-blur-xl md:p-14"
      >
        <h2 className="font-serif text-5xl leading-none tracking-[-0.05em] text-ink md:text-7xl">The demand is already here.</h2>
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-3">
          {stats.map(([value, label]) => (
            <div key={label} className="border border-ink/10 bg-pearl/70 p-6 text-left">
